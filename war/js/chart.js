/*
 *@developer Tiejia Zhao (tiejiazhao@gmail.com)
 *In this file. 
 *I defined a forecast class. When the page load, it will initial a chart. 
 *After the user choose a FAWN station, it will fetch temperature data and store them in fawn and nws.
 *Then, add series in to the chart and show it in the page. 
 *In the meanwhile, the page will also display a table which compares the forecast temperatures and station temperatures.
 **/
